  ...
  <div id="header">
    ...
    <nav role="navigation">
      <ul>
        ...
        <li class="items" v-on:click="NavigateMain">Démarrer</li>
        <li class="items">Séries</li>
        <li class="items">Films</li>
        <li class="items">Les plus récents</li>
        <li class="items" v-on:click="NavigateMyList">Ma liste</li>
        <li></li>
      </ul>
    </nav>
    <div id="textForm">
      <form>
        <input type="text" name="text" placeholder="Titres, personnes et genres" />
      </form>
    </div>
    <div id="icons">
